...
\Address{
  ...
  %URL: \url{https://mephisto.unige.ch/weightedcluster/}
}
...
\end{center}
Studer, Matthias (2013). WeightedCluster Library Manual: A practical guide to creating typologies of trajectories in the social sciences with R. \textit{LIVES Working Papers}, 24. {DOI}: \url{https://dx.doi.org/10.12682/lives.2296-1658.2013.24}.
...
%% preliminary R commands
%% install.packages("WeightedCluster", repos="https://R-Forge.R-project.org")
