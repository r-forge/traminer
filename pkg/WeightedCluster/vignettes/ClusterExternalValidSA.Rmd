---
title: 'Validating Sequence Analysis Typologies To be Used in Subsequent Regression: R Code introduction'
author: "Matthias Studer"
output: rmarkdown::html_vignette
bibliography: [manual.bib,packages.bib]
vignette: >
  %\VignetteEngine{knitr::rmarkdown}
  %\VignetteIndexEntry{Validating Sequence Analysis Typologies To be Used in Subsequent Regression: R Code introduction}
