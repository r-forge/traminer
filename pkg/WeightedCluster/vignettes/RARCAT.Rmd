...
We will use here the same dataset (`mvad`) and dissimilarity matrix (`diss`) as before. For sake of illustration, we start by considering the two clusters solution. These clusters are visualized below with state distribution plots.
